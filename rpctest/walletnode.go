...
// walletTestConfig contains all the args, and data required to launch a abcwallet process
...
// command returns the exec.Cmd which will be used to start the abcwallet
// process.
...
// to connect to the abcwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for abcwallet.
...
// Start creates a new abcwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running abcwalletTest process process, and waits until it exits
