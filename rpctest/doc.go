// Package rpctest contains tests for abcwallet's RPC server and a harness used
// to facilitate the tests by setting up a temporary Simnet node and wallet. The
// RPC client implementation in abcrpcclient is used exclusively to test the RPC
