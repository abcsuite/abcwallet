...
import (
	...
	_ "github.com/abcsuite/abcwallet/walletdb/bdb" // driver loaded during init
)
...
type Loader struct {
	...
	chainClient *abcrpcclient.Client
...
func (l *Loader) SetChainClient(chainClient *abcrpcclient.Client) {
	l.mu.Lock()
