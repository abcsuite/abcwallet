...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in aero",
	"getbalance--result1":    "The balance of all accounts valued in aero",
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in AER/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in aero",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in aero",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in aero",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and aero amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in aero",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in aero",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in aero",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in aero",
	...
	"listunspentresult-amount":        "The amount of the output valued in aero",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in aero",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in aero to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in aero",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in aero",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in aero",
	...
	"setticketmaxprice-max":       "The max price (in AER).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in aero",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in aero.",
	...
	"getwalletfee--result0":  "Current tx fee (in AER)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in aero",
