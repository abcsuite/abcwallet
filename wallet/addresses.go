...
func (w *Wallet) nextAddress(persist persistReturnedChildFunc, account, branch uint32,
	callOpts ...NextAddressCallOption) (abcutil.Address, error) {
...
func (w *Wallet) watchFutureAddresses(dbtx walletdb.ReadTx) error {
	...
	for account, a := range w.addressBuffers {
		...
		addrs := make([]abcutil.Address, 0, deriveExt+deriveInt)
...
func (w *Wallet) NewExternalAddress(account uint32, callOpts ...NextAddressCallOption) (abcutil.Address, error) {
...
func (w *Wallet) NewInternalAddress(account uint32, callOpts ...NextAddressCallOption) (abcutil.Address, error) {
	return w.nextAddress(w.persistReturnedChild(nil), account, udb.InternalBranch, callOpts...)
}

func (w *Wallet) newChangeAddress(persist persistReturnedChildFunc, account uint32) (abcutil.Address, error) {
...
// policy.
func (w *Wallet) NewChangeAddress(account uint32) (abcutil.Address, error) {
...
func (w *Wallet) AccountBranchAddressRange(account, branch, start, end uint32) ([]abcutil.Address, error) {
	if end < start {
...
func deriveChildAddresses(key *hdkeychain.ExtendedKey, startIndex, count uint32, params *chaincfg.Params) ([]abcutil.Address, error) {
	addresses := make([]abcutil.Address, 0, count)
...
func deriveChildAddress(key *hdkeychain.ExtendedKey, child uint32, params *chaincfg.Params) (abcutil.Address, error) {
