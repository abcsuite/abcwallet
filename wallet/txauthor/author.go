...
// InputSourceError.
type InputSource func(target abcutil.Amount) (total abcutil.Amount,
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb abcutil.Amount,
