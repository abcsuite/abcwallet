...
func StakePoolTicketFee(stakeDiff abcutil.Amount, relayFee abcutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) abcutil.Amount {
	...
	return abcutil.Amount(num.Int64())
}
