...
func (w *Wallet) SelectInputs(targetAmount abcutil.Amount, policy OutputSelectionPolicy) (total abcutil.Amount,
...
func (w *Wallet) OutputInfo(op *wire.OutPoint) (OutputInfo, error) {
	...
	err := walletdb.View(w.db, func(dbtx walletdb.ReadTx) error {
		...
		info.Amount = abcutil.Amount(txDetails.TxRecord.MsgTx.TxOut[op.Index].Value)
