...
Package walletdb provides a namespaced database interface for abcwallet.
...
[![GoDoc](https://godoc.org/github.com/abcsuite/abcwallet/walletdb?status.png)](http://godoc.org/github.com/abcsuite/abcwallet/walletdb)

Full `go doc` style documentation for the project can be viewed online without
installing this package by using the GoDoc site here:
http://godoc.org/github.com/abcsuite/abcwallet/walletdb

You can also view the documentation locally once the package is installed with
the `godoc` tool by running `godoc -http=":6060"` and pointing your browser to
http://localhost:6060/pkg/github.com/abcsuite/abcwallet/walletdb

## Installation

```bash
$ go get github.com/abcsuite/abcwallet/walletdb
```

## Examples

* [Basic Usage Example](http://godoc.org/github.com/abcsuite/abcwallet/walletdb#example-package--BasicUsage)  
