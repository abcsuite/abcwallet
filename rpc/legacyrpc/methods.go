...
import (
	...
	"github.com/abcsuite/abcd/blockchain/stake"
...
// request into a marshalable response.  If the error is a *abcjson.RPCError
...
// catch-all error code, abcjson.ErrRPCWallet.
...
var rpcHandlers = map[string]struct {
	...
	// Reference methods which can't be implemented by abcwallet due to
...
func unimplemented(interface{}, *wallet.Wallet) (interface{}, error) {
	return nil, &abcjson.RPCError{
		Code:    abcjson.ErrRPCUnimplemented,
		Message: "Method unimplemented",
	}
}

// unsupported handles a standard bitcoind RPC request which is
// unsupported by abcwallet due to design differences.
func unsupported(interface{}, *wallet.Wallet) (interface{}, error) {
	return nil, &abcjson.RPCError{
		Code:    -1,
		Message: "Request unsupported by abcwallet",
	}
}
...
// context.
type lazyHandler func() (interface{}, *abcjson.RPCError)
...
func lazyApplyHandler(request *abcjson.Request, activeNet *chaincfg.Params, w *wallet.Wallet, chainClient *chain.RPCClient) lazyHandler {
	handlerData, ok := rpcHandlers[request.Method]
	if ok && handlerData.handlerWithChain != nil && w != nil && chainClient != nil {
		return func() (interface{}, *abcjson.RPCError) {
			cmd, err := abcjson.UnmarshalCmd(request)
			if err != nil {
				return nil, abcjson.ErrRPCInvalidRequest
			}
...
func makeResponse(id, result interface{}, err error) abcjson.Response {
	idPtr := idPointer(id)
	if err != nil {
		return abcjson.Response{
			ID:    idPtr,
			Error: jsonError(err),
		}
	}
	...
	if err != nil {
		return abcjson.Response{
			ID: idPtr,
			Error: &abcjson.RPCError{
				Code:    abcjson.ErrRPCInternal.Code,
...
func jsonError(err error) *abcjson.RPCError {
	if err == nil {
		return nil
	}
	...
	switch e := err.(type) {
	case abcjson.RPCError:
		return &e
	case *abcjson.RPCError:
		return e
	case DeserializationError:
		code = abcjson.ErrRPCDeserialization
	case InvalidParameterError:
		code = abcjson.ErrRPCInvalidParameter
	case ParseError:
		code = abcjson.ErrRPCParse.Code
	case apperrors.E:
		switch e.ErrorCode {
		case apperrors.ErrWrongPassphrase:
			code = abcjson.ErrRPCWalletPassphraseIncorrect
		}
	}
	return &abcjson.RPCError{
		Code:    code,
		Message: err.Error(),
	}
}
...
func accountAddressIndex(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.AccountAddressIndexCmd)
...
func accountSyncAddressIndex(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.AccountSyncAddressIndexCmd)
	account, err := w.AccountNumber(cmd.Account)
	if err != nil {
		return nil, err
	}
...
func makeMultiSigScript(w *wallet.Wallet, keys []string,
	...
	keysesPrecious := make([]*abcutil.AddressSecpPubKey, len(keys))
	...
	for i, a := range keys {
		...
		default:
			...
			pubKeyAddr, err := abcutil.NewAddressSecpPubKey(
...
func addMultiSigAddress(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.AddMultisigAddressCmd)
	...
	secp256k1Addrs := make([]abcutil.Address, len(cmd.Keys))
	...
	err = chainClient.LoadTxFilter(false, []abcutil.Address{p2shAddr}, nil)
	if err != nil {
		return nil, err
	}
...
func addTicket(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	err = w.AddTicket(abcutil.NewTx(mtx))
...
func consolidate(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ConsolidateCmd)
	...
	var changeAddr abcutil.Address
	if cmd.Address != nil {
		if *cmd.Address != "" {
...
func createMultiSig(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.CreateMultisigCmd)
	...
	address, err := abcutil.NewAddressScriptHash(script, w.ChainParams())
	if err != nil {
		// above is a valid script, shouldn't happen.
		return nil, err
	}

	return abcjson.CreateMultiSigResult{
...
func dumpPrivKey(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.DumpPrivKeyCmd)
...
func generateVote(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GenerateVoteCmd)
	...
	resp := &abcjson.GenerateVoteResult{
		Hex: txHex,
	}
...
func getAddressesByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetAddressesByAccountCmd)
...
func getBalance(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetBalanceCmd)
	...
	result := abcjson.GetBalanceResult{
	...
	if accountName == "*" {
		...
		for _, bal := range balances {
			...
			json := abcjson.GetAccountBalanceResult{
...
func getBestBlock(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	result := &abcjson.GetBestBlockResult{
		Hash:   hash.String(),
		Height: int64(height),
	}
	return result, nil
...
func decodeAddress(s string, params *chaincfg.Params) (abcutil.Address, error) {
	...
	if len(s) == 66 || len(s) == 130 {
		...
		pubKeyAddr, err := abcutil.NewAddressSecpPubKey(pubKeyBytes,
			params)
		if err != nil {
			return nil, err
		}
	...
	addr, err := abcutil.DecodeAddress(s, params)
	if err != nil {
		msg := fmt.Sprintf("Invalid address %q: decode failed with %#q", s, err)
		return nil, &abcjson.RPCError{
			Code:    abcjson.ErrRPCInvalidAddressOrKey,
			Message: msg,
		}
	}
...
func getAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetAccountCmd)
...
// appear in the blockchain, or any tx that has arrived in the abcd mempool).
// If the most recently-requested address has been used, a new address (the
// next chained address in the keypool) is used.  This can fail if the keypool
// runs out (and will return abcjson.ErrRPCWalletKeypoolRanOut if that happens).
func getAccountAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetAccountAddressCmd)
...
func getUnconfirmedBalance(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetUnconfirmedBalanceCmd)
...
func importPrivKey(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.ImportPrivKeyCmd)
	...
	wif, err := abcutil.DecodeWIF(cmd.PrivKey)
	if err != nil {
		return nil, &abcjson.RPCError{
			Code:    abcjson.ErrRPCInvalidAddressOrKey,
...
func importScript(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.ImportScriptCmd)
...
func createNewAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.CreateNewAccountCmd)
...
func renameAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.RenameAccountCmd)
...
func getMultisigOutInfo(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.GetMultisigOutInfoCmd)
	...
	result := &abcjson.GetMultisigOutInfoResult{
...
func getNewAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetNewAddressCmd)
...
func getRawChangeAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetRawChangeAddressCmd)
...
func getReceivedByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetReceivedByAccountCmd)
...
func getReceivedByAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetReceivedByAddressCmd)
...
func getMasterPubkey(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.GetMasterPubkeyCmd)
...
func getStakeInfo(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	...
	resp := &abcjson.GetStakeInfoResult{
...
func getTickets(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.GetTicketsCmd)
...
func getTransaction(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	ret := abcjson.GetTransactionResult{
		TxID:            cmd.Txid,
	...
	var (
		debitTotal  abcutil.Amount
		creditTotal abcutil.Amount // Excludes change
		fee         abcutil.Amount
		feeF64      float64
	)
	...
	if len(details.Debits) == len(details.MsgTx.TxIn) {
		var outputTotal abcutil.Amount
		for _, output := range details.MsgTx.TxOut {
			outputTotal += abcutil.Amount(output.Value)
		}
	...
	if len(details.Debits) == 0 {
		...
		ret.Details = make([]abcjson.GetTransactionDetailsResult, 0,
			len(details.Credits))
	} else {
		ret.Details = make([]abcjson.GetTransactionDetailsResult, 1,
			len(details.Credits)+1)

		ret.Details[0] = abcjson.GetTransactionDetailsResult{
			// Fields left zeroed:
			//   InvolvesWatchOnly
			//   Account
			//   Address
	...
	for _, cred := range details.Credits {
		...
		ret.Details = append(ret.Details, abcjson.GetTransactionDetailsResult{
			// Fields left zeroed:
			//   InvolvesWatchOnly
			//   Fee
			Account:  accountName,
...
func getVoteChoices(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	resp := &abcjson.GetVoteChoicesResult{
		Version: version,
		Choices: make([]abcjson.VoteChoice, len(agendas)),
	}
	...
	for i := range choices {
		resp.Choices[i] = abcjson.VoteChoice{
...
func help(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.HelpCmd)

	// abcd returns different help messages depending on the kind of
	...
	// wallet itself is a websocket client to abcd.  Therefore, create a
	...
	// texts in a non-internal abcd package.
	postClient := func() *abcrpcclient.Client {
		if chainClient == nil {
			return nil
		}
...
func listAccounts(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListAccountsCmd)
...
func listReceivedByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListReceivedByAccountCmd)
	...
	jsonResults := make([]abcjson.ListReceivedByAccountResult, 0, len(results))
	for _, result := range results {
		jsonResults = append(jsonResults, abcjson.ListReceivedByAccountResult{
...
func listReceivedByAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListReceivedByAddressCmd)
	...
	ret := make([]abcjson.ListReceivedByAddressResult, numAddresses)
	idx := 0
	for address, addrData := range allAddrData {
		ret[idx] = abcjson.ListReceivedByAddressResult{
			Address:       address,
...
func listSinceBlock(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.ListSinceBlockCmd)
	...
	res := abcjson.ListSinceBlockResult{
...
func listScripts(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	listScriptsResultSIs := make([]abcjson.ScriptInfo, len(redeemScripts))
	for i, redeemScript := range redeemScripts {
		p2shAddr, err := abcutil.NewAddressScriptHash(redeemScript,
			w.ChainParams())
		if err != nil {
			return nil, err
		}
		listScriptsResultSIs[i] = abcjson.ScriptInfo{
			Hash160:      hex.EncodeToString(p2shAddr.Hash160()[:]),
			Address:      p2shAddr.EncodeAddress(),
			RedeemScript: hex.EncodeToString(redeemScript),
		}
	}
	return &abcjson.ListScriptsResult{Scripts: listScriptsResultSIs}, nil
}

// listTransactions handles a listtransactions request by returning an
// array of maps with details of sent and recevied wallet transactions.
func listTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListTransactionsCmd)
...
func listAddressTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListAddressTransactionsCmd)
...
func listAllTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListAllTransactionsCmd)
...
func listUnspent(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ListUnspentCmd)
...
func lockUnspent(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.LockUnspentCmd)
...
func purchaseTicket(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	cmd := icmd.(*abcjson.PurchaseTicketCmd)
	spendLimit, err := abcutil.NewAmount(cmd.SpendLimit)
	if err != nil {
		return nil, err
	}
	if spendLimit < 0 {
	...
	var ticketAddr abcutil.Address
...
// and amounts.
func makeOutputs(pairs map[string]abcutil.Amount, chainParams *chaincfg.Params) ([]*wire.TxOut, error) {
	outputs := make([]*wire.TxOut, 0, len(pairs))
	for addrStr, amt := range pairs {
		addr, err := abcutil.DecodeAddress(addrStr, chainParams)
		if err != nil {
...
// All errors are returned in abcjson.RPCError format
func sendPairs(w *wallet.Wallet, amounts map[string]abcutil.Amount,
...
func redeemMultiSigOut(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.RedeemMultiSigOutCmd)
	...
	srtc := &abcjson.SignRawTransactionCmd{
		RawTx:    txDataStr,
		Inputs:   &rtis,
		PrivKeys: &[]string{},
		Flags:    &sigHashAll,
	...
	srtTyped := signedTxResult.(abcjson.SignRawTransactionResult)
	return abcjson.RedeemMultiSigOutResult(srtTyped), nil
}
...
func redeemMultiSigOuts(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.RedeemMultiSigOutsCmd)
	...
	p2shAddr, ok := addr.(*abcutil.AddressScriptHash)
	if !ok {
	...
	itr := uint32(0)
	rmsoResults := make([]abcjson.RedeemMultiSigOutResult, len(msos))
	for i, mso := range msos {
		if itr > max {
			break
		}

		rmsoRequest := &abcjson.RedeemMultiSigOutCmd{
		...
		redeemResultTyped := redeemResult.(abcjson.RedeemMultiSigOutResult)
		rmsoResults[i] = redeemResultTyped

		itr++
	}

	return abcjson.RedeemMultiSigOutsResult{Results: rmsoResults}, nil
}
...
func rescanWallet(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.RescanWalletCmd)
...
func stakePoolUserInfo(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.StakePoolUserInfoCmd)

	userAddr, err := abcutil.DecodeAddress(cmd.User, w.ChainParams())
	if err != nil {
		return nil, err
	}
	...
	resp := new(abcjson.StakePoolUserInfoResult)
	for _, ticket := range spui.Tickets {
		var ticketRes abcjson.PoolUserTicket
...
func ticketsForAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.TicketsForAddressCmd)

	addr, err := abcutil.DecodeAddress(cmd.Address, w.ChainParams())
	if err != nil {
		return nil, err
	}
	...
	return abcjson.TicketsForAddressResult{Tickets: ticketHashStrs}, nil
}
...
func sendFrom(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	...
	amt, err := abcutil.NewAmount(cmd.Amount)
	if err != nil {
		return nil, err
	}
	pairs := map[string]abcutil.Amount{
		cmd.ToAddress: amt,
	}
...
func sendMany(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	// Recreate address/amount pairs, using abcutil.Amount.
	pairs := make(map[string]abcutil.Amount, len(cmd.Amounts))
	for k, v := range cmd.Amounts {
		amt, err := abcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
		pairs[k] = amt
...
func sendToAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.SendToAddressCmd)
...
func sendToMultiSig(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.SendToMultiSigCmd)
	account := uint32(udb.DefaultAccountNum)
	amount, err := abcutil.NewAmount(cmd.Amount)
	if err != nil {
		return nil, err
	}
	nrequired := int8(*cmd.NRequired)
	minconf := int32(*cmd.MinConf)
	pubkeys := make([]*abcutil.AddressSecpPubKey, len(cmd.Pubkeys))
	...
	result := &abcjson.SendToMultiSigResult{
		TxHash:       ctx.MsgTx.TxHash().String(),
		Address:      addr.EncodeAddress(),
		RedeemScript: hex.EncodeToString(script),
	}

	err = chainClient.LoadTxFilter(false, []abcutil.Address{addr}, nil)
	if err != nil {
		return nil, err
	}
...
func sendToSStx(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	...
	// Recreate address/amount pairs, using abcutil.Amount.
	pair := make(map[string]abcutil.Amount, len(cmd.Amounts))
	for k, v := range cmd.Amounts {
		pair[k] = abcutil.Amount(v)
	}
...
func sendToSSGen(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.SendToSSGenCmd)
...
func sendToSSRtx(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.SendToSSRtxCmd)
...
func setTicketFee(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.SetTicketFeeCmd)
	...
	incr, err := abcutil.NewAmount(cmd.Fee)
	if err != nil {
		return nil, err
	}
...
func setTxFee(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	...
	relayFee, err := abcutil.NewAmount(cmd.Amount)
	if err != nil {
		return nil, err
	}
...
func setVoteChoice(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.SetVoteChoiceCmd)
...
func signMessage(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.SignMessageCmd)
...
func signRawTransaction(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*abcjson.SignRawTransactionCmd)
	...
	// TODO: really we probably should look these up with abcd anyway to
	// make sure that they match the blockchain if present.
	inputs := make(map[wire.OutPoint][]byte)
	scripts := make(map[string][]byte)
	var cmdInputs []abcjson.RawTxInput
	if cmd.Inputs != nil {
	...
	for _, rti := range cmdInputs {
		...
		if cmd.PrivKeys != nil && len(*cmd.PrivKeys) != 0 {
			...
			addr, err := abcutil.NewAddressScriptHash(redeemScript,
				w.ChainParams())
			if err != nil {
				return nil, DeserializationError{err}
			}
	...
	// querying abcd with getrawtransaction. We queue up a bunch of async
	// requests and will wait for replies after we have checked the rest of
	// the arguments.
	requested := make(map[wire.OutPoint]abcrpcclient.FutureGetTxOutResult)
	...
	var keys map[string]*abcutil.WIF
	if cmd.PrivKeys != nil {
		keys = make(map[string]*abcutil.WIF)

		for _, key := range *cmd.PrivKeys {
			wif, err := abcutil.DecodeWIF(key)
			if err != nil {
				return nil, DeserializationError{err}
			}
			...
			case chainec.ECTypeSecp256k1:
				addr, err = abcutil.NewAddressSecpPubKey(wif.SerializePubKey(),
					w.ChainParams())
				if err != nil {
					return nil, DeserializationError{err}
				}
			case chainec.ECTypeEdwards:
				addr, err = abcutil.NewAddressEdwardsPubKey(
					wif.SerializePubKey(),
					w.ChainParams())
				if err != nil {
					return nil, DeserializationError{err}
			...
			case chainec.ECTypeSecSchnorr:
				addr, err = abcutil.NewAddressSecSchnorrPubKey(
					wif.SerializePubKey(),
					w.ChainParams())
				if err != nil {
					return nil, DeserializationError{err}
	...
	signErrors := make([]abcjson.SignRawTransactionError, 0, len(signErrs))
	for _, e := range signErrs {
		input := tx.TxIn[e.InputIndex]
		signErrors = append(signErrors, abcjson.SignRawTransactionError{
	...
	return abcjson.SignRawTransactionResult{
...
func signRawTransactions(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	...
	return &abcjson.SignRawTransactionsResult{Results: toReturn}, nil
}

// validateAddress handles the validateaddress command.
func validateAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.ValidateAddressCmd)

	result := abcjson.ValidateAddressWalletResult{}
	addr, err := decodeAddress(cmd.Address, w.ChainParams())
	if err != nil {
...
func verifyMessage(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.VerifyMessageCmd)
	...
	var buf bytes.Buffer
	wire.WriteVarString(&buf, 0, "Aero Signed Message:\n")
	...
	case *abcutil.AddressPubKeyHash: // ok
		return bytes.Equal(abcutil.Hash160(serializedPubKey),
			checkAddr.Hash160()[:]), nil
	case *abcutil.AddressSecpPubKey: // ok
...
func version(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	var resp map[string]abcjson.VersionResult
	if chainClient != nil {
		var err error
...
func walletInfo(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	...
	return &abcjson.WalletInfoResult{
...
func walletPassphrase(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.WalletPassphraseCmd)
...
func walletPassphraseChange(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*abcjson.WalletPassphraseChangeCmd)
